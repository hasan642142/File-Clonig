...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-AKASH ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • A　K　A　S　H　ツ ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38AKASH ]   ║\33[1;34m   
╠══[Whatsapp                 • 01307958615 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 0.1 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	AKASHj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	AKASHj('\033[0;97m===============================================')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Akash-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
...
def Subscraption():
  ...
  if key1 in r1:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m AKASH, ToOLs Daily Update")
		...
		os.system('am start https://wa.me/+8801307958615?text=' + tks)
		Subscraption() 
Subscraption() 
login()